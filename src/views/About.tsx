        ...
        <Container sx={{ my: 10 }}>
            ...
            <Paper variant="outlined" elevation={0} sx={{ p: 2, m: 2 }}>
                <ManSection title="name">
                    Paul Wrubel - software engineer and technology enthusiast
                </ManSection>
                <ManSection title="description">
                    Paul Wrubel is a software engineer from Michigan. He
                    attended Michigan Technology University where he graduated
                    with a B.S. in Computer Science and a Minor in Mathematics.
                    During this, he served as a Software Engineering Intern at
                    Vertafore in East Lansing, Michigan.
                    <br />
                    <br />
                    Currently, he works as a Senior Software Engineer at Target
                    Corporation in Minneapolis, Minnesota, where he works on
                    maintaining observability data within the company.
                    <br />
                    <br />
                ...
                <ManSection title="attributes">
                    ...
                    <ManSubsection title="Languages">
                        golang, typescript, javascript, python, java, scala, c
                    </ManSubsection>
